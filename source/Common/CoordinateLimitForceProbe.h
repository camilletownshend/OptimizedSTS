#ifndef OPENSIM_COORDINATE_LIMIT_FORCE_PROBE_H_
#define OPENSIM_COORDINATE_LIMIT_FORCE_PROBE_H_
/* -------------------------------------------------------------------------- *
 *                    OpenSim:  CoordinateLimitForceProbe.h                   *
 * -------------------------------------------------------------------------- *
...
//=============================================================================
/**
 * CoordinateLimitForceProbe is a ModelComponent Probe for computing the 
...
class SLJCOMMON_API CoordinateLimitForceProbe : public Probe
{
    OpenSim_DECLARE_CONCRETE_OBJECT(CoordinateLimitForceProbe, Probe);
...
//==============================================================================
    ...
    /**@{**/
    /** List of CoordinateLimitForces to probe.  **/
    OpenSim_DECLARE_LIST_PROPERTY(coordinate_limit_force_names, std::string,
        "Specify a list of model CoordinateLimitForces whose activation should be calculated."
    ...
    OpenSim_DECLARE_PROPERTY(exponent, double,
        "Element-wise power exponent to apply to each coordinate limit force prior to the Probe operation.");
	OpenSim_DECLARE_PROPERTY(force_threshold, double, 
		"Threshold above which the penalty begins to apply");
    /**@}**/
...
//==============================================================================
private:
    // The index inside OpenSim::ForceSet that corresponds to each Actuator
    // being probed.
    SimTK::Array_<int> _forceIndex;
...
//==============================================================================
};	// END of class CoordinateLimitForceProbe
//==============================================================================
//==============================================================================
